...
describe('ServiceSelector', () => {
  ...
  test('unit-1 : Should correctly calculate total minutes and units for CMS method. 2 services and 20 total minutes for 1 total units', () => {
    const { getByLabelText, getByText, getAllByRole } = render(
      <ServiceSelector />
    );
  ...
  test('unit-2 : Should correctly calculate total minutes and units for CMS method. 2 services and 40 total minutes for 3 total units', () => {
    const { getByLabelText, getByText, getAllByRole } = render(
      <ServiceSelector />
    );
  ...
  test('unit-3 : Should correctly calculate total minutes and units for CMS method. 2 services and 12 total minutes for 1 total units', () => {
    const { getByLabelText, getByText, getAllByRole } = render(
      <ServiceSelector />
    );
  ...
  test('unit-4 : Should correctly calculate total minutes and units for CMS method. 2 services and 23 total minutes for 2 total units', () => {
    const { getByLabelText, getByText, getAllByRole } = render(
      <ServiceSelector />
    );
  ...
  test('unit-5 : Should correctly calculate total minutes and units for CMS method. 2 services and 25 total minutes for 2 total units', () => {
    const { getByLabelText, getByText, getAllByRole } = render(
      <ServiceSelector />
    );
  ...
  test('unit-6 : Should correctly calculate total minutes and units for CMS method. 4 services and 40 total minutes for 4 total units', () => {
    const { getByLabelText, getByText, getAllByRole } = render(
      <ServiceSelector />
    );
  ...
  test('unit-7 : Should correctly calculate total minutes and units for CMS method. 4 services and 53 total minutes for 5 total units', () => {
    const { getByLabelText, getByText, getAllByRole } = render(
      <ServiceSelector />
    );
  ...
  test('unit-8 : Should correctly calculate total minutes and units for CMS method. 5 services and 38 total minutes for 4 total units', () => {
    const { getByLabelText, getByText, getAllByRole } = render(
      <ServiceSelector />
    );
    ...
    // Select service 97110 and add 20 minutes
    ...
    const minutesInput97110 = container.querySelector('#charge-97110-minutes');
    fireEvent.change(minutesInput97110, { target: { value: '20' } });
    ...
    // Select service 97112 and add 5 minutes

    fireEvent.change(serviceSelect, {
      target: { value: 'Time Based::Neuromuscular re-education::97112' },
    });
    const minutesInput97112 = container.querySelector('#charge-97112-minutes');
    fireEvent.change(minutesInput97112, { target: { value: '5' } });
